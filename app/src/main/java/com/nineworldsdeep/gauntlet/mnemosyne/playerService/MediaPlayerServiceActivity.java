...
public class MediaPlayerServiceActivity extends AppCompatActivity {
    ...
    public static final String Broadcast_PLAY_NEW_AUDIO =
            "com.nineworldsdeep.gauntlet.PlayNewAudio";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_media_player_service);
...
//        playAudio(audioList.get(0).getData());
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Toast.makeText(MediaPlayerServiceActivity.this, "Service Bound", Toast.LENGTH_SHORT).show();
        }
    ...
    private boolean checkAndRequestPermissions() {
        ...
        Utils.toast(this, "media player service unsupported for APIs < 5.0, use AudioDisplayActivity");
        return false;
    }
