...
public class SynergyV5TemplateActivity extends AppCompatActivity {

    private static final int MENU_CONTEXT_QUEUE_ID = 3;

    private SynergyV5Template stf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String templateName =
                intent.getStringExtra(
                        SynergyV5TemplatesActivity.EXTRA_TEMPLATENAME);
    ...
    private void queuePosition(int position) {
        ...
        SynergyV5Utils.queueFromTemplate(stf, position);
